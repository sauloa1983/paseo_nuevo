...
$(document).ready(function(){
	...
	function gridLayoutSwitcher() {
		...
		function gridClear(gridColumns) {
			...
			$(".listings-container > .listing-item:nth-child("+gridColumns+"n), .listings-container > .pe-property-card:nth-child("+gridColumns+"n)").after("<div class='clearfix'></div>");
		}
	    ...
	    // switcher buttons: navegación real para persistir ?layout= en paginación y filtros
